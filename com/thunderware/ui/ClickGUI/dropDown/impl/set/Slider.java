...
public class Slider extends SetComp {
    ...
    public int drawScreen(int mouseX, int mouseY, double x, double y) {
        ...
        Gui.drawRect(this.x + 1, this.y + font.getHeight() - 8, (int) (this.x - 1+ (this.parent.getWidth() * distance)), this.y + this.height - 1, this.hovered ? ClickGui.getMainColor().darker().getRGB():Hud.getColor(2));
