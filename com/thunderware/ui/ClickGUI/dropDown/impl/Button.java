...
public class Button {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks, double plusplus) {
		...
		Gui.drawRect(panel.x + 1,panel.y + y + plusplus, panel.x + panel.width - 1, panel.y + y + height + plusplus, mod.isToggled() ? !isHovered(mouseX, mouseY) ? Hud.getColor((int) y/25) : new Color(Hud.getColor((int) y/25)).darker().getRGB() : isHovered(mouseX, mouseY) ? 
