...
public class MainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public MainMenu()
    {
        ...
        try
        {
            ...
            list.clear();
            list = Arrays.asList("dont trust no","Bape!!","DefaultNCP 1.8 disabler!","vn cat hospital","DOPECLIENT","Using vape v4 rn..","#crackedbyskidunion","[NOVOLINE.WTF]","Akrien !!!!");
            if (!list.isEmpty())
            {
                while (true)
                {
    ...
    private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_)
    {
        ...
        for (int j = 0; j < i * i; ++j)
        {
            ...
            for (int k = 0; k < 6; ++k)
            {
                ...
                this.mc.getTextureManager().bindTexture(titlePanoramaPath);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        int k = 30;
        this.drawGradientRect(0, 0, this.width, this.height, new Color(25,25,25).getRGB(), new Color(25,25,25).getRGB());
        ...
        GlStateManager.rotate(20,20,0, 0);
        this.drawTexturedModalRect(-200, -mc.displayHeight/16, 0, 0, 256, 150);
        //this.drawCenteredString(this.fontRendererObj, this.splashText, -96, 105, -256);
        GlStateManager.popMatrix();
        String s = "Thunderware " + Thunder.i.buildVersion;
        ...
        String s1 = "Copyright Thunderware Devs. Do not distribute!";
